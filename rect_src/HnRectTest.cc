 ...
 * $Id: HnRectTest.cc,v 1.2 1997/06/02 09:35:31 katayama Exp $
 */
...
new_HnRect(double x1, double x2, double y1, double y2)
{
	...
	rect.setRange(x1, HnRange::INCLUSIVE, x2, HnRange::INCLUSIVE, 0);
	rect.setRange(y1, HnRange::INCLUSIVE, y2, HnRange::INCLUSIVE, 1);

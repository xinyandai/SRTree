 ...
 * $Id: storeSRTree.cc,v 1.3 1997/06/02 09:35:53 katayama Exp $
 */
...
static void storeSRTree(const char *dataFileName, const char *treeFileName,
...
main(int argc, char *argv[])
{
	...
	storeSRTree(dataFileName, treeFileName, dimension, maxCount, debug);
...
{
	fprintf(stderr, "\
Usage: storeSRTree [options] dimension datafile treefile\n\
Options\n\
...
static void
storeSRTree(const char *dataFileName, const char *treeFileName, int dimension,
